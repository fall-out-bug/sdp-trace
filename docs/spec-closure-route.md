...
| --- | --- |
| Source commit inspected | PR #64 head `5c47e09a223c318968f3e6099c59ed51f9995520` |
| Open GitHub PRs | PR #64 open, not draft, merge state `CLEAN`; `verify` and `pr-review-evidence-only` passed at head `5c47e09a223c318968f3e6099c59ed51f9995520` |
