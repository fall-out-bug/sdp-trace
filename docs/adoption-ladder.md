...
Adopt `sdp-trace` in steps. Do not start with a full workflow migration.

## Level 0: Read-Only Assessment

Inspect one repository and identify where evidence would come from.

## Level 1: Evidence Bundle

Capture scope, provenance, and evidence for one real change.
...
Adopt a full operator workflow only when the team wants SDP to own delivery orchestration.
