...
| Evidence | State |
| --- | --- |
| Task ledger | 605 / 605 checked; 0 open |
...
| D006 | 019 T019-001/T002/T003/T004/T120 | Decide post-merge governance for PR #60/Spec 019: accept partial merge state, reject it, or split remaining debt. | Maintainer decision `split_successor` recorded in the 2026-05-26 closure thread; PR #60 merged with missed gates; PR #63 final-head CI passed; post-merge closure plan exists; follow-up Spec 022 is filed. | Maintainer decision recorded against the closure plan. | `split_successor` |
