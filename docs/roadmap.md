...
| [022](../specs/022-post-merge-governance-closure/) | Post-merge governance closure | `in_progress` | Active on PR #72 from `codex/022-post-merge-governance-closure`; plan/task review Round 2 has no retained critical or major findings; US1 evidence summary, US2 decision state, US3 navigation sync, final local verification, and fixed-handoff PR-ready re-review are recorded. Remaining work: final-head PR #72 CI/merge evidence. PR #60 merge approval remains `not_assessed`. |
| [023](../specs/023-numbered-code-file-locality-cleanup/) | Numbered code file locality cleanup | `complete` | PR #73 merged on 2026-06-05 after final-head `verify` and `pr-review-evidence-only` passed; task ledger is 80 / 80 checked. No production trust, release approval, or external attestation is claimed. |
...
| [021](../specs/021-source-file-locality-cleanup/) | Source file locality cleanup | `complete` | PR #73 merged on 2026-06-05 after final-head `verify` and `pr-review-evidence-only` passed; task ledger is 1243 / 1243 checked. No production trust, release approval, or external attestation is claimed. |
...
| Authority envelope / trust boundary | 002 | PR-level review, merge approval, merge, and post-merge CI are represented |
| Product contract schema | 005 | Contract and implementation placeholders are artifact-complete via Spec 006; historical approval gap accepted |
| Change evidence packet | 006 | Implemented and reviewed locally; historical pre-implementation approval gap accepted |
| GitHub demo workflow | 007 | Existing demo track approved; external demo evidence and buyer rehearsal represented |
...
| Source file locality cleanup | 021 | Merged via PR #73; no production trust, release approval, or external attestation claimed |
| Numbered code file locality cleanup | 023 | Merged via PR #73; no production trust, release approval, or external attestation claimed |
| Repo realignment / monitoring / gate readiness | 019 | Workstreams implemented; residual governance split to Spec 022 |
| Post-merge governance closure | 022 | PR-ready governance closure on PR #72; PR #60 approval remains `not_assessed`; final closure pending final-head PR #72 CI/merge evidence |
