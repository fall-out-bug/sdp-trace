...
| field | value |
| --- | --- |
| Pattern file | `archive/research/block-24-redaction-denylist.patterns` |
| Pattern sha256 | `c5ba21129cbc0c969a2d02b46a15bed1cf8c3d48d51643b4eeb6f899150cbbb7` |
| Clean command | `rg --pcre2 -n -f .sdp-trace-src/archive/research/block-24-redaction-denylist.patterns .sdp-trace-report` |
| No-OIDC command | `rg --pcre2 -n -f .sdp-trace-src/archive/research/block-24-redaction-denylist.patterns .sdp-trace-report` |
