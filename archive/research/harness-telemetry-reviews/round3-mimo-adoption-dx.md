...
```bash
cat > /Users/fall_out_bug/projects/vibe_coding/sdp-trace/archive/research/harness-telemetry-reviews/round3-pi-staff-engineer-adoption-dx.md << 'REVIEW_EOF'
# Round 3 Adoption/DX Review: Staff Engineer / Platform Owner

**Source text**: `archive/research/harness-telemetry-trust-brief.md`
...
echo "Saved to archive/research/harness-telemetry-reviews/round3-pi-staff-engineer-adoption-dx.md"
```
