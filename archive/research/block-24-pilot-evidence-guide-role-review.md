...
- `archive/research/block-24-demo-repo-ci-evidence-guide.md` now documents a
  compiled Kotlin/JVM target upgrade path without broad compatibility claims.
- `archive/research/block-24-demo-repo-ci-trace-pilot-report.md` no longer carries
