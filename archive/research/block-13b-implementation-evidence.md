...
- `archive/research/block-13b-minimax-implementation-review.md`:
  MiniMax-M2.7 accepted with no critical or major findings.
- `archive/research/block-13b-glm-implementation-review.md`:
  GLM-5.1 found two major findings: missing doctor acceptance checks and
  missing preview boundary/offline surfaces.
- `archive/research/block-13b-glm-implementation-review-2.md`:
