...
artifact sets with
`archive/research/block-24-redaction-denylist.patterns`
...
```bash
rg --pcre2 -n -f .sdp-trace-src/archive/research/block-24-redaction-denylist.patterns .sdp-trace-report
```
