...
- **Artifact Family**: A selected evidence category such as run, report, witness, provenance, evidence, trace, artifact index, redaction scan, review, or change/branch CI evidence whose presence, absence, access state, and binding state can be observed independently.
