...
- [ ] T211 [US3] Update the demo repository with a pinned `kt_jvm_library` and
  ...
  checks secondary.
  Status: `cannot_verify` in this environment. Current GitHub access cannot
  resolve `fall-out-bug/sdp-trace-demo-ci-pilot`, so demo repository state is
  not live-verifiable from this worktree.
