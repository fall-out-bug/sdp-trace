...
| S25-TE-06 | minor | tracing/evidence | Sanitized report format was unconstrained. | Accepted and fixed. Spec now requires Markdown under `archive/research/`, not a schema-validated fixture under `examples/`. | ZAI/GLM-5.1 Socratic review |
