...
- `archive/research/opencode-minimax-kotlin-bazel-proof-report.md`: human-readable tested-on report after a real run.
- `examples/pilot-runs/opencode-minimax-kotlin-bazel/`: committed sanitized proof package after a real run.
- `archive/research/opencode-model-run-card.md`: update with the new runner command and exact MiniMax proof boundary.
- `archive/research/kotlin-bazel-fixture-plan.md`: update with E2E proof requirements and Bazel execution proof state.
...
- Add `archive/research/opencode-minimax-kotlin-bazel-proof-report.md` with:
...
```bash
rg -n "OpenCode|MiniMax|Kotlin|Bazel|not_assessed|no policy verdict" archive/research/opencode-minimax-kotlin-bazel-proof-report.md examples/pilot-runs/opencode-minimax-kotlin-bazel
```
...
rg -n "opencode-minimax-kotlin-bazel" docs/harness-compatibility-matrix.md docs/model-compatibility.md archive/research/opencode-model-run-card.md
```
