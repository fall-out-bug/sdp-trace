...
- `spec.md`
- `tasks.md`
- Existing pilot target artifacts under `docs/research/`, `docs/harness-compatibility-matrix.md`, `docs/model-compatibility.md`, `docs/jvm-bazel-guide.md`, and `examples/jvm-bazel/`
...
| F009 | major | `sdp-trace-cdn.22.18` | Existing run-card template owns native pass/warn/fail verdicts. | Accepted; implementation fixed. | `docs/research/run-card-template.md` now uses evidence states, reason codes, artifact references, and optional external-verdict input. |
...
| F019 | minor/P3 | `sdp-trace-cdn.22.9` | Package naming blurred Block 05 design and customer handoff outline. | Accepted; spec layer revised. | Block file title now says "Block 05 Design"; `docs/research/customer-pilot-evidence-package.md` remains the T037 handoff outline. |
