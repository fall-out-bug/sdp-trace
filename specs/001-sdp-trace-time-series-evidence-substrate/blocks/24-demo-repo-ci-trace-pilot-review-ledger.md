...
| I24-CC-02 | major | code/correctness | OpenRouter Qwen 3.6 Plus | false_positive | Reviewer judged the denylist pattern file missing because it reviewed only the implementation diff. The file exists at `archive/research/block-24-redaction-denylist.patterns` from commit `5ced37b`; current blob `a6225493d2f935503a684394ad656659fc8715fe`. |
