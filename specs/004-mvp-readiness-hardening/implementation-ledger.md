...
| `go test ./... -coverprofile=/tmp/sdp-trace-mvp-cover.out` | pass | Total coverage: 67.4%. |
...
| `go run ./tools/crapcheck -cover-func /tmp/sdp-trace-mvp-cover-func.txt -gocyclo /tmp/sdp-trace-mvp-gocyclo.txt -threshold 5` | fail_assessed_gap | 391 functions exceed strict CRAP threshold 5. |
...
| `internal/harnessobs` | 42.7% | 42.7% |
| `internal/verifier` | 51.1% | 51.1% |
| total | 64.0% | 67.4% |
...
|---|---:|---:|---:|---|
| `internal/harnessobs.normalizeOpenCodeRawLine` | 37 | 0.0% | 1406.00 | assessed_gap |
...
1. `internal/harnessobs.normalizeOpenCodeRawLine`
2. `internal/harnessobs.LoadSessionProfile`
3. `internal/harnessobs.CollectSession`
4. `internal/trace.writeCanonicalJSON`
5. `internal/interaction.ValidateEvent`
