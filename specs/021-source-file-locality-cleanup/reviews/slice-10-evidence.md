# Slice 10 Evidence: Command Surface Catalog Locality
...
- `gofmt -w cmd/sdp-trace/command_surface_catalog.go`: pass
- `go test ./cmd/sdp-trace`: pass
- `go run ./tools/qualitycheck -mi-under 70 cmd/sdp-trace/command_surface_catalog.go`:
